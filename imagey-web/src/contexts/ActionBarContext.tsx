...
export const ActionBarContext = createContext<ActionIconsState>({actionIcons: [], setActionIcons: ()=>{}});

export function ActionBarContextProvider({ children}: {children:  JSX.Element }) {
	const [actionIcons, setActionIcons] = useState<JSX.Element[]>([]);
	return <ActionBarContext.Provider value={{actionIcons, setActionIcons}}>{children}</ActionBarContext.Provider>
}
